...
const Welcome = () => {
    ...
    return (
        <div className='welcome-section w-full h-dvh text-[#2A2725]  md:px-7 px-6'>
            <div className='flex flex-col gap-2 tracking-[-4] leading-2'>
                <div className="w-full md:w-[86%] md:text-[64px] text-[34px] welcome-line md:py-20">
            ...
            <div className="flex md:flex-row flex-col justify-between items-center md:p-4 md:mt-0 mt-10">

...
const GalleryModal = ({ selectedItem, isOpen, onClose, setSelectedItem, mediaItems }) => {
    ...
    return (
        <>
            ...
            >
                <motion.div
                    className="relative rounded-xl bg-gray-800/80 backdrop-blur-xl 
    ...
    return (
        <div className="container mx-auto px-4 py-16 md:py-24 max-w-[1400px]">
            <div className="mb-12 text-center flex flex-col items-center">
                ...
                <motion.h2
                    className="font-headline-lg text-2xl sm:text-headline-lg md:text-5xl text-forest-deep leading-tight"
                ...
                <motion.p
                    className="mt-6 font-body-md text-sm sm:text-base md:text-body-md text-on-surface-variant leading-relaxed max-w-2xl"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
            ...
            <AnimatePresence mode="wait">
                {selectedItem ? (
                    ...
                    <motion.div
                        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 auto-rows-[250px] grid-flow-dense"
                        initial="hidden"
                        whileInView="visible"
                    ...
                    >
                        {items.map((item, index) => (
                            <motion.div
                                ...
                                className={`relative overflow-hidden rounded-2xl cursor-move group smooth-shadow ${item.span}`}
                            ...
                            >
                                ...
                                <motion.div
                                    ...
                                    initial={{ opacity: 1 }}
                                >
                                    <div className="absolute inset-0 bg-gradient-to-t from-forest-deep/90 via-forest-deep/30 to-transparent opacity-90 transition-opacity duration-300 group-hover:opacity-100" />
                                    <div className="relative z-10 transition-transform duration-300 transform translate-y-2 group-hover:translate-y-0">
                                      <h3 className="text-white text-lg sm:text-xl md:text-2xl font-headline-md font-medium leading-tight mb-2">
                                          {item.title}
                                      </h3>
                                      <p className="text-white/90 text-sm sm:text-base line-clamp-2 font-body-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
                                          {item.desc}
                                      </p>
                                    </div>
                                </motion.div>

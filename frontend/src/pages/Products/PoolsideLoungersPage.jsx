...
import carouselImg3 from "../../assets/products/Product Images/Poolside Loungers/Ultra_high-quality_8K_Red_Magic_202605281553.jpeg";
...
const PoolsideLoungersPage = () => {
    ...
    useEffect(() => {
        ...
        const sessionKey = "urbanland_exit_intent_poolsideloungerspage";
                    ...
                    <div className="relative bg-white text-[#1A1A1A] max-w-lg w-full rounded-[2.5rem] z-10 p-8 sm:p-12 shadow-2xl">
                        ...
                        {!exitPopupSubmitted ? (
                            <div className="flex flex-col items-center text-center">
                                <h3 className="text-xl sm:text-2xl font-black uppercase text-[#1A1A1A] mb-3">Download the Poolside Loungers Buyer's Guide</h3>
